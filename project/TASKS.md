...
- [ ] Requirement change: In addition to the inverted color, add a green tint to those pixels to cope with trying to invert middle-gray, which becomes nearly the same middle-gray again.
